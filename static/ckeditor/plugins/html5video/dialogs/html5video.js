            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        label: editor.lang.common.browseServer,
                        // hidden: true,
                        filebrowser:{action:"Browse",target:"info:poster",url:editor.config.filebrowserImageBrowseUrl, ckCsrfToken: sessionStorage.getItem('token')}
                    } ]
                }]
            },
            {
