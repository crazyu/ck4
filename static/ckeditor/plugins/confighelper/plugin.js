...
(function () {
  ...
  function dataIsEmpty (data) {
    ...
    if (!value || value == '<br>' || value == '<p>&nbsp;<br></p>' || value == '<p><br></p>' || value == '<div><br></div>' || value == '<p>&nbsp;</p>' || value == '&nbsp;' || value == ' ' || value == '&nbsp;<br>' || value == ' <br>') { return true }
  ...
  CKEDITOR.plugins.add('confighelper', {
    ...
    init: function (editor) {
      ...
      if (placeholder) {
        ...
        if (CKEDITOR.env.ie && CKEDITOR.env.version < 11) { node.$.styleSheet.cssText = content } else { node.$.innerHTML = content }
